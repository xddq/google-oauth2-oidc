...
/**
 * Using declaration merging to correctly set the types for express
 * request.session. Everything copy pasted from @types/express-session besides
 * the custom types and the intersection type in the session below.
 **/
...
declare global {
  namespace Express {
    ...
    interface Request {
       ...
       * @see SessionData
       */
      // NOTE: only change was intersecting with own SessionData.
